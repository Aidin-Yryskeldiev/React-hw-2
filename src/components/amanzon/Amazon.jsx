import "./Amazon.css";
import rating1 from "../../assets/images/rating-0.png";
import rating2 from "../../assets/images/rating-05.png";
import rating3 from "../../assets/images/rating-10.png";
import rating4 from "../../assets/images/rating-15.png";
import rating5 from "../../assets/images/rating-20.png";
import rating6 from "../../assets/images/rating-25.png";
import rating7 from "../../assets/images/rating-30.png";
import rating8 from "../../assets/images/rating-35.png";
import rating9 from "../../assets/images/rating-40.png";
...
const Amazon = () => {
	const raiting = (stars) => {
		...
		else if (stars <= 1.5) return rating4;
		else if (stars <= 2) return rating5;
		else if (stars <= 2.5) return rating6;
		else if (stars <= 3) return rating7;
		else if (stars <= 3.5) return rating8;
		else if (stars <= 4) return rating9;
		else if (stars <= 4.5) return rating10;
		else return rating11;
	};
	const products = [
		{
		...
		},
		{
			...
			image:
				"https://i5.walmartimages.com/seo/Miniyam-50L-13Gal-Heavy-Duty-Hands-Free-Stainless-Steel-Trash-Can-with-Foot-Pedal-Fingerprint-Resistant-Soft-Close-Lid-Garbage-Can-Silver_a134999f-eec4-428f-9e0e-2391e3b475ac.cab7f9335b45b7d990515aa28ac30b6e.jpeg?odnHeight=768&odnWidth=768&odnBg=FFFFFF",
	...
	return (
		<div className="photo">
			{products.map((item) => (
				<div className="pacha" key={item.id}>
					<img className="img" src={item.image} alt="Photo" />
					<p className="text">{item.name}</p>
					<p className="text">${item.priceCents}</p>
					<p className="text">{item.keywords}</p>
